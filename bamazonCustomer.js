...
connection.connect(function(err){
    ...
    var schema = {
        properties: {
            ID: {
            message: "Please enter the product you would like.",
            pattern: /^[0-20][0-20]$|^[0-20]$/,
            required: true
            },
            howMany: {
            message: "How Many?.",
            pattern: /^[0-20][0-20]$|^[0-20][0-20][0-20]$/,
            required: true
            }
        }
    };
...
var beginApp = function(){
    ...
    var getBamazonProducts = function (products){
        console.log("Hello, and welcome! Please chceck out the products avbailable to you.");
